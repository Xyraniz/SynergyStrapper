...
using SynergyStrapper.Models.RobloxApi;
using DiscordRPC;
...
namespace SynergyStrapper.Integrations
{
    public class DiscordRichPresence : IDisposable
    {
        ...
        private void ProcessSetRichPresence(Message message, bool implicitUpdate)
        {
            ...
            Models.SynergyStrapperRPC.RichPresence? presenceData;
            ...
            try
            {
                presenceData = message.Data.Deserialize<Models.SynergyStrapperRPC.RichPresence>();
            }
            catch (Exception)
            {
        ...
        public async Task<bool> SetCurrentGame()
        {
            ...
            string status = _activityWatcher.Data.ServerType switch
            {
                ...
                _ => $"by {universeDetails.Data.Creator.Name}" + (universeDetails.Data.Creator.HasVerifiedBadge ? " (verified)" : ""),
            };
            ...
            // this is used for configuration from SynergyStrapperRPC
