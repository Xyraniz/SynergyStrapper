...
namespace SynergyStrapper
{
    ...
    {
#if QA_BUILD
        public const string ProjectName = "SynergyStrapper-QA";
#else
        public const string ProjectName = "SynergyStrapper";
#endif
        public const string ProjectDisplayName = "Synergy Strapper";
        ...
        public static string WebUrl
        {
            get {
                ...
                string url = ConstructSynergyStrapperWebUrl();
        ...
        public static string ConstructSynergyStrapperWebUrl()
        {
        ...
        {
            if (!Settings.Prop.EnableAnalytics || String.IsNullOrWhiteSpace(WebUrl))
                return;
        ...
        {
            if (!Settings.Prop.EnableAnalytics || !CanSendLogs() || String.IsNullOrWhiteSpace(WebUrl))
                return;
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            Logger.WriteLine(LOG_IDENT, $"Starting {ProjectDisplayName} v{Version}");
            ...
            else
            {
                ...
                State.Load();
                FastFlags.Load();
                FastFlags.ApplyPerformancePreset(Settings.Prop.UsePerformancePreset);
