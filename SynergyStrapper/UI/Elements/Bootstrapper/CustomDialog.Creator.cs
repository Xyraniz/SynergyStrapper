...
namespace SynergyStrapper.UI.Elements.Bootstrapper
{
    public partial class CustomDialog
    {
        ...
        {
            ["SynergyStrapperCustomBootstrapper"] = HandleXmlElement_SynergyStrapperCustomBootstrapper_Fake,
        ...
        private static void AssertThemeVersion(string? versionStr)
        {
            if (string.IsNullOrEmpty(versionStr))
                throw new CustomThemeException("CustomTheme.Errors.VersionNotSet", "SynergyStrapperCustomBootstrapper");

            if (!uint.TryParse(versionStr, out uint version))
                throw new CustomThemeException("CustomTheme.Errors.VersionNotNumber", "SynergyStrapperCustomBootstrapper");
            ...
            switch (version)
            {
                ...
                case 0: // Themes made between Oct 19, 2024 to Mar 11, 2025 (on the feature/custom-bootstrappers branch)
                    throw new CustomThemeException("CustomTheme.Errors.VersionNotSupported", "SynergyStrapperCustomBootstrapper", version);
                default:
                    throw new CustomThemeException("CustomTheme.Errors.VersionNotRecognised", "SynergyStrapperCustomBootstrapper", version);
            }
        }
        ...
        private void HandleXmlBase(XElement xml)
        {
            ...
            if (xml.Name != "SynergyStrapperCustomBootstrapper")
                throw new CustomThemeException("CustomTheme.Errors.InvalidRoot", "SynergyStrapperCustomBootstrapper");
            ...
            // handle root
            HandleXmlElement_SynergyStrapperCustomBootstrapper(this, xml);
