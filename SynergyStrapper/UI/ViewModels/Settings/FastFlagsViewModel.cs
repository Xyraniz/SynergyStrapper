...
namespace SynergyStrapper.UI.ViewModels.Settings
{
    public class FastFlagsViewModel : NotifyPropertyChangedViewModel
    {
        ...
        public bool UsePerformancePreset
        {
            get => App.Settings.Prop.UsePerformancePreset;
            set
            {
                App.Settings.Prop.UsePerformancePreset = value;
                App.FastFlags.ApplyPerformancePreset(value);
                OnPropertyChanged(nameof(UsePerformancePreset));
            }
        }
