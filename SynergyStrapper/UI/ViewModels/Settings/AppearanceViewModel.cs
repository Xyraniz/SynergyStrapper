...
using SynergyStrapper.UI.Elements.Settings;
using SynergyStrapper.UI.Elements.Editor;
            ...
            set
            {
                if (String.IsNullOrEmpty(value))
                {
                    if (App.Settings.Prop.BootstrapperIcon == BootstrapperIcon.IconCustom)
                        App.Settings.Prop.BootstrapperIcon = BootstrapperIcon.IconSynergyStrapper;
                }
                else
                {
