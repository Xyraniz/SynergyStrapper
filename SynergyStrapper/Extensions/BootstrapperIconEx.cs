...
namespace SynergyStrapper.Extensions
{
    static class BootstrapperIconEx
    {
        ...
        {
            BootstrapperIcon.IconSynergyStrapper,
            ...
            BootstrapperIcon.IconSynergyStrapperClassic,
        ...
        public static Icon GetIcon(this BootstrapperIcon icon)
        {
            ...
            if (icon == BootstrapperIcon.IconCustom)
            {
                ...
                return customIcon ?? Properties.Resources.IconSynergyStrapper;
            }

            return icon switch
            {
                BootstrapperIcon.IconSynergyStrapper => Properties.Resources.IconSynergyStrapper,
                ...
                BootstrapperIcon.IconSynergyStrapperClassic => Properties.Resources.IconSynergyStrapperClassic,
                _ => Properties.Resources.IconSynergyStrapper
            };
        }
    }
}
