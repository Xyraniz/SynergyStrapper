...
using SynergyStrapper.UI.Elements.Bootstrapper.Base;
...
namespace SynergyStrapper
{
    public class Bootstrapper
    {
        ...
        public string BackgroundUpdaterMutexName => $"SynergyStrapper-BackgroundUpdater-{_launchMode}";

        public string MutexNamePrefix { get; set; } = "SynergyStrapper-Bootstrapper";
                ...
                catch (Exception ex)
                {
                    ...
                    if (ex.GetType() == typeof(ChecksumFailedException))
                    {
                        ...
                        Frontend.ShowConnectivityDialog(
                            ...
                            String.Format(Strings.Dialog_Connectivity_UnableToDownloadReason, $"[Synergy Strapper support]({App.ProjectHelpLink})"),
